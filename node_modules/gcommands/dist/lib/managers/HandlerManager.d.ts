import type { AutocompleteInteraction, Collection, CommandInteraction, ContextMenuInteraction, Message, MessageComponentInteraction, ModalSubmitInteraction } from 'discord.js';
...
export declare class HandlerManager {
    ...
    componentHandler: (interaction: MessageComponentInteraction | ModalSubmitInteraction) => any;
    ...
    setComponentHandler(handler: (interaction: MessageComponentInteraction | ModalSubmitInteraction) => any): HandlerManager;
