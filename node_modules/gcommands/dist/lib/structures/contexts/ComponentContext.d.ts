import type { CacheType, GuildCacheMessage, InteractionDeferReplyOptions, InteractionDeferUpdateOptions, InteractionReplyOptions, MessageComponentInteraction, MessagePayload, ModalSubmitFieldsResolver, ModalSubmitInteraction, WebhookEditMessageOptions } from 'discord.js';
...
export declare class ComponentContext<Cached extends CacheType = CacheType> extends Context<Cached> {
    ...
    inGuild: () => this is ComponentContext<'raw' | 'cached'>;
